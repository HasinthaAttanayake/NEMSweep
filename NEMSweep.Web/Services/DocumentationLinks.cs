...
{
    private const string BaseUrl = "https://docs.nemsweep.com";
    ...
    /// <summary>The assumptions register itself: every model constant, checked against the code.</summary>
    public const string Assumptions = BaseUrl + "/assumptions/";

    /// <summary>The published contract an LLM can generate sweep definitions against.</summary>
    public const string LlmWorkflow = BaseUrl + "/exploring/llm-workflow.html";
}
