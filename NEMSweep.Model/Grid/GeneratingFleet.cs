...
public sealed class GeneratingFleet
{
    ...
    /// <see cref="NEMSweep.Model.Scenarios.GenerationCostParameters.ShortRunMarginalCostFor"/> at
        ...
        FlowSeries dispatchTimeline)
    {
        ...
        FlowSeries availableCapacity = GenerationTechnology switch
        {
            ...
            GenerationTechnology.Wind => WindPowerCurve.Calculate(
                RequireResourceProfile(resourceProfile).WindSpeed,
                NameplateCapacity,
                _windPowerCurveSettings),
            _ => NameplateAcrossTimeline(dispatchTimeline),
        };
    ...
    private FlowSeries SolarCapacity(RegionalResourceProfile resources) =>
        DualAxisSolarPowerCurve.Calculate(
    ...
    /// <summary>Dispatchable plant is available at nameplate in every interval.</summary>
    private FlowSeries NameplateAcrossTimeline(FlowSeries dispatchTimeline)
    {
